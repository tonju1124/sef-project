function FilePreview({ title, type = "PDF document", fileUrl }) {
  ...
  return (
    <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
      ...
      <button 
        ...
        disabled={!fileUrl}
        className="px-6 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-all duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed"
      >
        {fileUrl ? 'Download File' : 'No File Available'}
      </button>
    </div>
  );
}
